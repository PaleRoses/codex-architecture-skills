...
import Moonlight.Sheaf.Obstruction.Cohomological.Cache
  ( CohomologicalCache,
    ObstructionCacheKey (..),
  )
import Moonlight.Sheaf.Obstruction.Cohomological.Certification
  ( SectionCertificationAlgebra (..),
    environmentFingerprintFromCachePolicy,
  )
import Moonlight.Sheaf.Obstruction.Cohomological.Environment
  ( IndexedEnvironment,
    ObstructionEnvironmentAlgebra,
  )
import Moonlight.Sheaf.Obstruction.Cohomological.Exact
...
import Moonlight.Sheaf.Obstruction.Cohomological.Policy
  ( CohomologicalPolicy,
  )
import Moonlight.Sheaf.Obstruction.Cohomological.Projection
  ( RelationProjectionConflict,
    SectionCoordinate,
    SectionProjection,
  )
import Moonlight.Sheaf.Obstruction.Cohomological.Pruning
  ( CohomologicalPruningGates,
  )
import Moonlight.Sheaf.Obstruction.Cohomological.Region
  ( RegionExactCoverage,
